...
EW_DEFINE_FIELDS( WidgetSetHorizontalSliderConfig, WidgetSetWidgetConfig )
  EW_PROPERTY( CoverBitmapDefault, ResourcesBitmap )
  ...
  EW_PROPERTY( ThumbOffsetActive, XPoint )
  EW_PROPERTY( ThumbOffsetFocused, XPoint )
  EW_PROPERTY( ThumbOffsetDisabled, XPoint )
  EW_PROPERTY( ThumbOffsetDefault, XPoint )
  ...
  EW_PROPERTY( TrackLeftBorderColorActive, XColor )
  EW_PROPERTY( TrackLeftBorderColorFocused, XColor )
  EW_PROPERTY( TrackLeftBorderColorDisabled, XColor )
  EW_PROPERTY( TrackLeftBorderColorDefault, XColor )
  EW_PROPERTY( TrackLeftBorderWidthActive, XInt32 )
  EW_PROPERTY( TrackLeftBorderWidthFocused, XInt32 )
  EW_PROPERTY( TrackLeftBorderWidthDisabled, XInt32 )
  EW_PROPERTY( TrackLeftBorderWidthDefault, XInt32 )
  ...
  EW_PROPERTY( TrackLeftMarginLeft, XInt32 )
