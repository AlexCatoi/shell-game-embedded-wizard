...
#ifndef _ApplicationLoadingGame_H
#define _ApplicationLoadingGame_H
...
/* Forward declaration of the class Application::LoadingGame */
#ifndef _ApplicationLoadingGame_
  EW_DECLARE_CLASS( ApplicationLoadingGame )
#define _ApplicationLoadingGame_
#endif
...
/* Deklaration of class : 'Application::LoadingGame' */
EW_DEFINE_FIELDS( ApplicationLoadingGame, CoreGroup )
  ...
  EW_OBJECT  ( PointEffect1,    EffectsPointEffect )
  EW_OBJECT  ( PointEffect2,    EffectsPointEffect )
  EW_ARRAY   ( Array,           XString, [4])
EW_END_OF_FIELDS( ApplicationLoadingGame )

/* Virtual Method Table (VMT) for the class : 'Application::LoadingGame' */
EW_DEFINE_METHODS( ApplicationLoadingGame, CoreGroup )
  ...
  EW_METHOD( Add,               void )( CoreGroup _this, CoreView aView, XInt32 
    aOrder )
EW_END_OF_METHODS( ApplicationLoadingGame )
...
#endif /* _ApplicationLoadingGame_H */
