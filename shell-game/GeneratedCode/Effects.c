...
static const XStringRes _Const0005 = { _StringsDefault0, 0x006C };
static const XStringRes _Const0006 = { _StringsDefault0, 0x00A9 };
...
EW_DEFINE_CLASS( EffectsPointEffect, EffectsEffect, Outlet, Outlet, Outlet, Outlet, 
...
EffectsFader EffectsSlideTransition_CreatePresentFader( EffectsSlideTransition _this )
{
  ...
  EffectsEffect_OnSetCycleDuration((EffectsEffect)&fader->OpacityEffect, 500 );
  ...
  EffectsEffect_OnSetCycleDuration((EffectsEffect)&fader->PositionEffect, 500 );
...
/* Re-Initializer for the auto object 'Effects::SlideLeftCentered' */
void EffectsSlideLeftCentered__ReInit( EffectsSlideTransition _this )
{
  EW_UNUSED_ARG( _this );
}
...
/* Re-Initializer for the auto object 'Effects::SlideRightCentered' */
void EffectsSlideRightCentered__ReInit( EffectsSlideTransition _this )
{
  EW_UNUSED_ARG( _this );
}
...
/* Re-Initializer for the auto object 'Effects::SlideUpCentered' */
void EffectsSlideUpCentered__ReInit( EffectsSlideTransition _this )
{
  EW_UNUSED_ARG( _this );
}
...
/* Re-Initializer for the auto object 'Effects::SlideDownCentered' */
void EffectsSlideDownCentered__ReInit( EffectsSlideTransition _this )
{
  EW_UNUSED_ARG( _this );
}
