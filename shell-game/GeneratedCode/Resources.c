...
/* Include a file containing the bitmap resource : 'Resources::NavigationIconsSmall' */
#include "_ResourcesNavigationIconsSmall.h"
...
/* Include a file containing the bitmap resource : 'Resources::PlayerIconsSmall' */
#include "_ResourcesPlayerIconsSmall.h"

/* Table with links to derived variants of the bitmap resource : 'Resources::PlayerIconsSmall' */
EW_RES_WITHOUT_VARIANTS( ResourcesPlayerIconsSmall )
