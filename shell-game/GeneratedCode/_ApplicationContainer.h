...
#ifndef _ApplicationContainer_H
#define _ApplicationContainer_H
...
/* Forward declaration of the class Application::Container */
#ifndef _ApplicationContainer_
  EW_DECLARE_CLASS( ApplicationContainer )
#define _ApplicationContainer_
#endif
...
/* Deklaration of class : 'Application::Container' */
EW_DEFINE_FIELDS( ApplicationContainer, CoreGroup )
  EW_OBJECT  ( Rectangle,       ViewsRectangle )
  EW_PROPERTY( Content,         CoreGroup )
EW_END_OF_FIELDS( ApplicationContainer )

/* Virtual Method Table (VMT) for the class : 'Application::Container' */
EW_DEFINE_METHODS( ApplicationContainer, CoreGroup )
  ...
  EW_METHOD( Add,               void )( CoreGroup _this, CoreView aView, XInt32 
    aOrder )
EW_END_OF_METHODS( ApplicationContainer )
