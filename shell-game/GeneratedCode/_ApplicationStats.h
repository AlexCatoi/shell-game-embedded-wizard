...
#ifndef _ApplicationStats_H
#define _ApplicationStats_H
...
/* Deklaration of class : 'Application::Stats' */
EW_DEFINE_FIELDS( ApplicationStats, CoreGroup )
  EW_OBJECT  ( Rectangle,       ViewsRectangle )
  EW_OBJECT  ( MaxLevel,        ViewsText )
  EW_OBJECT  ( Date,            ViewsText )
  EW_OBJECT  ( HoursPlayed,     ViewsText )
  EW_OBJECT  ( Corrects,        ViewsText )
...
EW_DEFINE_METHODS( ApplicationStats, CoreGroup )
  ...
  EW_METHOD( Add,               void )( CoreGroup _this, CoreView aView, XInt32 
    aOrder )
EW_END_OF_METHODS( ApplicationStats )
