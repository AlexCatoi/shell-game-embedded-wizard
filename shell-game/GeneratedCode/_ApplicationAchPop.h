...
#ifndef _ApplicationAchPop_H
#define _ApplicationAchPop_H
...
/* Forward declaration of the class Application::AchPop */
#ifndef _ApplicationAchPop_
  EW_DECLARE_CLASS( ApplicationAchPop )
#define _ApplicationAchPop_
#endif
...
/* Deklaration of class : 'Application::AchPop' */
EW_DEFINE_FIELDS( ApplicationAchPop, CoreGroup )
...
EW_END_OF_FIELDS( ApplicationAchPop )

/* Virtual Method Table (VMT) for the class : 'Application::AchPop' */
EW_DEFINE_METHODS( ApplicationAchPop, CoreGroup )
  ...
  EW_METHOD( Add,               void )( CoreGroup _this, CoreView aView, XInt32 
    aOrder )
EW_END_OF_METHODS( ApplicationAchPop )
