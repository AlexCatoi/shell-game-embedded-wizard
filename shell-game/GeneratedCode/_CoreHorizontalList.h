...
/* The class Core::HorizontalList provides a generic horizontal list view. Its purpose 
   ...
   - The width of the items is determined by the property @ItemWidth. The list is 
   optimized to manage items of equal width. If your application case does require 
   the items to have different width, associate a slot method to the property @OnQueryItemWidth. 
   ...
   This method is very useful if the content of the affected items (or their width) 
...
EW_DEFINE_FIELDS( CoreHorizontalList, CoreGroup )
  ...
  EW_VARIABLE( QueriedItemWidth, XInt32 )
...
EW_DEFINE_METHODS( CoreHorizontalList, CoreGroup )
  ...
  EW_METHOD( FindCurrentDialog, CoreGroup )( CoreHorizontalList _this )
  EW_METHOD( SwitchToDialog,    void )( CoreHorizontalList _this, CoreGroup aDialogGroup, 
    ...
    XBool aCombine )
  EW_METHOD( DismissDialog,     void )( CoreHorizontalList _this, CoreGroup aDialogGroup, 
    EffectsTransition aOverrideDismissTransition, EffectsTransition aOverrideOverlayTransition, 
    EffectsTransition aOverrideRestoreTransition, XSlot aComplete, XSlot aCancel, 
    XBool aCombine )
  EW_METHOD( PresentDialog,     void )( CoreHorizontalList _this, CoreGroup aDialogGroup, 
    EffectsTransition aPresentTransition, EffectsTransition aDismissTransition, 
    EffectsTransition aOverlayTransition, EffectsTransition aRestoreTransition, 
  ...
  EW_METHOD( FindSiblingView,   CoreView )( CoreHorizontalList _this, CoreView aView, 
    XSet aFilter )
  EW_METHOD( FadeGroup,         void )( CoreHorizontalList _this, CoreGroup aGroup, 
